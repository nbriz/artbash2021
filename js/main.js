...
const header = window.createHeader(null, true)
...
class Gallery extends CyberSpace {
  constructor (opts) {
    ...
    title.addEventListener('mouseover', () => this.insertDisk('artbash'))
    title.addEventListener('mouseout', () => this.ejectDisk())
    title.addEventListener('mouseover', () => { info.style.opacity = 1 })
    title.addEventListener('mouseout', () => { info.style.opacity = 0 })
